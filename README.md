<p align="center">
  <img src="assets/banner.svg" width="100%" alt="Victor Vinny Braz — Analista de Dados e BI. Dados que viram decisões." />
</p>
...
Sou **Victor Vinny Braz**, profissional de **Dados e Business Intelligence** com experiência em projetos no setor de telecomunicações. Trabalho com SQL, Power BI, Python e ETL para organizar dados, construir indicadores e automatizar processos.

Neste portfólio, reúno projetos que conectam **análise de dados, Machine Learning e desenvolvimento de soluções** a problemas concretos — da classificação de risco à organização financeira.
...
<h3>01 · Credit Risk Score</h3>
<p><strong>Machine Learning aplicado à análise de risco</strong></p>
...
<td width="62%" valign="top">
<h3>02 · Gupy Remote Job Monitor</h3>
<p><strong>Automação e classificação de oportunidades</strong></p>
...
<td width="62%" valign="top">
<h3>03 · Prevya</h3>
<p><strong>Dados financeiros em uma experiência de produto</strong></p>
...
| Dados e preparação | Business Intelligence | Análise e Machine Learning |
| :--- | :--- | :--- |
| SQL Server · SQL · SAS | Power BI · DAX | Python · Pandas · NumPy |
| ETL e transformação de dados | Indicadores e dashboards | Análise exploratória |
| Automação de processos | Visualização e comunicação | scikit-learn · Avaliação de modelos |

**Desenvolvimento aplicado aos projetos:** Streamlit · Playwright · React · TypeScript · PostgreSQL · Supabase · Git e GitHub.

## Sobre mim

Minha experiência em **Dados e BI no setor de telecomunicações** orienta a forma como desenvolvo soluções: entender o problema, preparar os dados e apresentar informações úteis para o negócio.

Os projetos acima mostram diferentes etapas desse trabalho, incluindo **automação, análise, avaliação de modelos e interfaces para explorar resultados**. Cada repositório traz o contexto, as tecnologias e as decisões envolvidas.
